...
pubFnCText()
{
   fnPullDown(scan_driver, 510, 430, 20) 
}

pubFnCPhoto()
{
   fnPullDown(scan_driver, 510, 430, 33) 
}

pubFnCGray()
{
   fnPullDown(scan_driver, 510, 430, 46) 
}

pubFnC8C()
{
   fnPullDown(scan_driver, 510, 430, 59) 
}

pubFnC8CPhoto()
{
   fnPullDown(scan_driver, 510, 430, 72) 
}

pubFnC16KCol()
{
   fnPullDown(scan_driver, 510, 430, 85) 
}
